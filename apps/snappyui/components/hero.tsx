...
function Hero() {
  return (
    <section className="py-20 px-7 md:px-10 text-center flex flex-col items-center dark:bg-black bg-white">
      ...
      <p className="text-gray-600 dark:text-gray-400 mb-10 max-w-xl text-sm md:text-base animate-fade-in" style={{ animationDelay: "0.3s" }}>
        A complete design system made for developers who care about performance and aesthetics.
      </p>
      ...
      <div className="flex flex-row gap-4 justify-center animate-fade-in" style={{ animationDelay: "0.5s" }}>
        ...
        <button type="button" className="bg-transparent border min-w-7/12 border-gray-300 dark:border-gray-700 text-black dark:text-white rounded-md px-6 py-2.5 font-medium hover:border-gray-500 transition-all duration-300 flex items-center gap-2 hover:shadow-md hover:-translate-y-0.5">
          <Github size={18} />
          Star on GitHub
        </button>
      </div>
