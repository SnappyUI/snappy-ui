...
>
    ...
    <Tab value="Preview">
     ...
     <div className="flex items-center justify-center">
        <HorizontalCard >
            <HorizontalCardImage className="" imageUrl="https://images.pexels.com/photos/30327991/pexels-photo-30327991/free-photo-of-historic-fort-in-okzitanien-france.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1" imageAlt="" />
