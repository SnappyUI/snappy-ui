...
function TooltipArrow({ ref, className, ...props }: React.ComponentPropsWithoutRef<typeof TooltipPrimitive.Arrow> & { variant?: string } & { ref?: React.RefObject<React.ElementRef<typeof TooltipPrimitive.Arrow> | null> }) {
  return (
